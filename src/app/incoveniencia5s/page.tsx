...
export default function InconveniencePage(){
    ...
    useEffect(()=>{inconvenienceService.list().then((page)=>setItems(page.content)).catch((error)=>toast.error(getServiceErrorMessage(error,"Não foi possível carregar as ocorrências 5S."))).finally(()=>setLoading(false));},[]);
