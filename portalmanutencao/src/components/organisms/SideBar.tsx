...
import { MonitorCog, MessageSquareWarning, ShoppingBag, ShoppingCart, Users } from 'lucide-react';
...
export function SideBar() {
  ...
  return (
    <aside
      ...
      className={`
        h-screen bg-weg-blue text-white flex flex-col gap-6 cursor-pointer
